...
### Task 3.1: Simplify Caption UI ✅ COMPLETE (10-15 min)
- [x] Remove upload progress components from `qcut/apps/web/src/components/editor/media-panel/views/captions.tsx` ✅
- [x] Remove `isUploading` and `uploadProgress` state ✅
- [x] Update UI to show only: "Extracting audio..." → "Transcribing..." → "Complete" ✅
- [x] Clean up unused imports (`UploadProgress` component) ✅

### Task 3.2: Update Configuration Check ✅ COMPLETE (5 min)
- [x] Create `qcut/apps/web/src/lib/gemini/gemini-utils.ts` ✅
- [x] Add `isGeminiConfigured()` function to check `GEMINI_API_KEY` ✅
- [x] Replace old `isTranscriptionConfigured()` calls ✅
- [x] Update UI to show Gemini-specific setup instructions ✅

### Task 3.3: Improve Error Handling ✅ COMPLETE (10 min)
- [x] Add Gemini-specific error messages in `qcut/apps/web/src/components/editor/media-panel/views/captions.tsx` ✅
- [x] Handle: API key missing, quota exceeded, audio format errors ✅
