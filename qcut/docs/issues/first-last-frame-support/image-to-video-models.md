...
**For detailed step-by-step implementation instructions with code snippets, see:**
...
- Update TypeScript interfaces in `ai-types.ts`
- Add helper functions to `ai-constants.ts`
- Write unit tests for helpers
- Document type changes


**Phase 2: Component Extraction (90-120 minutes)**
- Create new `ai-image-upload.tsx` component
- Implement conditional rendering for I2V vs F2V
- Add prop validation
- Create Storybook stories
- Write component unit tests

**Phase 3: Integration (90-120 minutes)**
- Add state variables to `ai.tsx`
- Integrate `AIImageUploadSection` component
- Implement validation logic
- Update API calls for frame data
- End-to-end testing with Veo 3.1 models
