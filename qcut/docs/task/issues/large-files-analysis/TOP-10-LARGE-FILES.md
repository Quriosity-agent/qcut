...
**Threshold**: 800+ lines
**Ordering**: Pending files first (need refactoring), then already refactored
...
|---|------|-------|----------|--------|
| 1 | `ai/constants/ai-constants.ts` | 1,594 | Configuration | Pending |
| 2 | `timeline/index.tsx` | 1,538 | UI Component | Pending |
| 3 | `lib/text2image-models.ts` | 1,417 | Configuration | Pending |
| 4 | `lib/export-engine.ts` | 1,365 | Export Logic | Pending |
| 5 | `ai/tabs/ai-image-tab.tsx` | 1,283 | UI Component | Pending |
| 6 | `electron/main.ts` | 1,282 | Electron Main | Pending |
| 7 | `ai/hooks/use-ai-generation.ts` | 1,860 | React Hook | ✅ Partially Refactored |
| 8 | `stores/timeline-store.ts` | 1,842 | State Management | ✅ Refactored (6 modules) |
| 9 | `ai/hooks/generation/model-handlers.ts` | 1,579 | AI Generation | ✅ New (extracted) |
| 10 | `lib/fal-ai-client.ts` | 1,405 | API Client | ✅ Partially Refactored |

---

## Pending Refactoring

### 1. ai-constants.ts (1,594 lines)
...
### 2. timeline/index.tsx (1,538 lines)
...
### 3. text2image-models.ts (1,417 lines)
...
### 4. export-engine.ts (1,365 lines)
...
### 5. ai-image-tab.tsx (1,283 lines)
...
### 6. electron/main.ts (1,282 lines)
...
### 7. use-ai-generation.ts (1,860 lines)
...
### 8. timeline-store.ts (1,842 lines)
...
### 9. model-handlers.ts (1,579 lines)
...
### 10. fal-ai-client.ts (1,405 lines)
...
|----------|-------|-----------|
| High | `ai-constants.ts` | Configuration, easy split, largest pending |
| High | `timeline/index.tsx` | Core UI, complex interactions |
| High | `electron/main.ts` | Entry point, growing complexity |
| Medium | `text2image-models.ts` | Config, can group by provider |
...
| ✅ Partial | `use-ai-generation.ts`, `fal-ai-client.ts` | Further extraction possible |
