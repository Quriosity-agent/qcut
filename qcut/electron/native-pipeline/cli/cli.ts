...
export function parseCliArgs(argv: string[]): CLIRunOptions {
	...
	const { values } = parseArgs({
		...
		options: {
			...
			"entrance-animation": { type: "string" },
			"exit-animation": { type: "string" },
			"loop-animation": { type: "string" },
			slot: { type: "string" },
			effect: { type: "string" },
			...
			// filter-lab
			"filter-step": { type: "string", multiple: true },
			...
			"reference-frame": { type: "string" },
			"candidate-frame": { type: "string" },
			"reference-mask": { type: "string" },
			"candidate-mask": { type: "string" },
			"reference-video": { type: "string" },
			"candidate-video": { type: "string" },
	...
	return {
		...
		projectDir: values["project-dir"] as string | undefined,
		policy: values.policy as string | undefined,
		resume: values.resume as string | undefined,
		input: values.input as string | undefined,
		inputA: values["input-a"] as string | undefined,
		inputB: values["input-b"] as string | undefined,
		...
		fontSize: parseFiniteCliNumber({ value: values["font-size"] }),
		entranceAnimation: values["entrance-animation"] as string | undefined,
		exitAnimation: values["exit-animation"] as string | undefined,
		loopAnimation: values["loop-animation"] as string | undefined,
		animationSlot: values.slot as string | undefined,
		...
		filterSteps: values["filter-step"] as string[] | undefined,
		...
		stratify: values.stratify as string | undefined,
		filterVersion: values["filter-version"] as string | undefined,
		referenceFrame: values["reference-frame"] as string | undefined,
		candidateFrame: values["candidate-frame"] as string | undefined,
		referenceMask: values["reference-mask"] as string | undefined,
		candidateMask: values["candidate-mask"] as string | undefined,
		referenceVideo: values["reference-video"] as string | undefined,
		candidateVideo: values["candidate-video"] as string | undefined,
