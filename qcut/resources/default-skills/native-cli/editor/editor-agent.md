...
```bash
qcut editor:snapshot:select --ref @e3 --value "720p" --force --json
```
...
```bash
# Check
qcut editor:snapshot:check --ref @e4 --checked --force --json

# Uncheck
qcut editor:snapshot:check --ref @e4 --no-checked --force --json
```
