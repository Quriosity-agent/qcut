...
```bash
# Dictionary location: <project>/.claude/skills/videocut-subtitles/dictionary.txt
# Script loads it automatically

bash ../videocut-talk-edit/scripts/volcengine_transcribe.sh "https://o.uguu.se/xxxxx.mp3"
```
...
```bash
cd subtitles-dir/
node <project>/.claude/skills/videocut-subtitles/scripts/subtitle_server.js 8898 "video.mp4"
```
