...
describe("Transcription API Migration", () => {
  ...
  describe("Feature Flag Testing", () => {
    ...
    it("should fall back to Next.js API when Electron API fails", async () => {
      ...
      mockElectronAPI.transcribe.audio.mockRejectedValue(
  ...
  describe("Error Handling", () => {
    it("should handle Electron API errors gracefully", async () => {
      ...
      const errorResult = {
        ...
        message:
          "Auto-captions require environment variables: MODAL_TRANSCRIPTION_URL. Check README for setup instructions.",
      };
  ...
  describe("Language Support", () => {
    ...
    it("should handle specific language requests", async () => {
      ...
      mockElectronAPI.transcribe.audio.mockResolvedValue(
        specificLanguageResult
      );
