...
describe('Button Component', () => {
  ...
  it('applies variant classes', () => {
    const { rerender } = render(<Button type="button" variant="default">Default</Button>);
    let button = screen.getByRole('button');
    expect(button).toHaveClass('bg-foreground', 'text-background');
    
    rerender(<Button type="button" variant="primary">Primary</Button>);
    button = screen.getByRole('button');
    expect(button).toHaveClass('bg-primary', 'text-primary-foreground');
    
    rerender(<Button type="button" variant="destructive">Destructive</Button>);
    button = screen.getByRole('button');
    expect(button).toHaveClass('bg-destructive', 'text-destructive-foreground');
    
    rerender(<Button type="button" variant="outline">Outline</Button>);
    button = screen.getByRole('button');
    expect(button).toHaveClass('border', 'border-input');
    
    rerender(<Button type="button" variant="secondary">Secondary</Button>);
    button = screen.getByRole('button');
    expect(button).toHaveClass('bg-secondary', 'text-secondary-foreground');
    
    rerender(<Button type="button" variant="text">Text</Button>);
    button = screen.getByRole('button');
    expect(button).toHaveClass('bg-transparent', 'p-0');
    
    rerender(<Button type="button" variant="link">Link</Button>);
    button = screen.getByRole('button');
    expect(button).toHaveClass('text-primary', 'underline-offset-4');
  });
  
  it('applies size classes', () => {
    const { rerender } = render(<Button type="button" size="default">Default</Button>);
    let button = screen.getByRole('button');
    expect(button).toHaveClass('h-9', 'px-4');
    
    rerender(<Button type="button" size="sm">Small</Button>);
    button = screen.getByRole('button');
    expect(button).toHaveClass('h-8', 'px-3', 'text-xs');
    
    rerender(<Button type="button" size="lg">Large</Button>);
    button = screen.getByRole('button');
    expect(button).toHaveClass('h-10', 'px-8');
    
    rerender(<Button type="button" size="icon">Icon</Button>);
    button = screen.getByRole('button');
  ...
  it('handles multiple clicks', () => {
    const onClick = vi.fn();
    render(<Button type="button" onClick={onClick}>Multi-click</Button>);
  ...
  it('disables button when disabled prop is true', () => {
    const onClick = vi.fn();
    render(<Button type="button" disabled onClick={onClick}>Disabled</Button>);
    const button = screen.getByRole('button');
  ...
  it('applies custom className', () => {
    render(<Button type="button" className="custom-class another-class">Custom</Button>);
    const button = screen.getByRole('button');
  ...
  it('forwards ref correctly', () => {
    ...
    render(<Button type="button" ref={ref}>Ref Button</Button>);
