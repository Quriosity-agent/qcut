...
export const THUMBNAIL_TEMPLATES = TRANSFORMATIONS.filter(t => 
  t.category === "viral" || t.category === "enhancement"
);

export const TITLE_CARD_TEMPLATES = TRANSFORMATIONS.filter(t => 
  t.category === "artistic" || t.category === "enhancement"
);

export const LOGO_TEMPLATES = TRANSFORMATIONS.filter(t => 
  t.category === "product" || t.category === "artistic"
);

export const EFFECT_PRESETS = TRANSFORMATIONS.filter(t => 
