	...
	test: {
		...
		server: {
			deps: {
				...
				inline: [/^node:/, "crypto", "fs", "path", "child_process", "os", "util", "stream", "events", "http", "https", "net", "tls", "zlib", "buffer", "url", "querystring", "string_decoder", "assert", "tty", "dgram", "dns", "readline"],
			},
		},
	},
	resolve: {
