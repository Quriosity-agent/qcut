...
const BUILTIN_PLUGINS: Array<{ slot: PluginSlot; name: string; pkg: string }> =
	[
		...
		// Agents
		{
			slot: "agent",
			name: "claude-code",
			pkg: "@composio/ao-plugin-agent-claude-code",
		},
		...
		// Workspaces
		{
			slot: "workspace",
			name: "worktree",
			pkg: "@composio/ao-plugin-workspace-worktree",
		},
		{
			slot: "workspace",
			name: "clone",
			pkg: "@composio/ao-plugin-workspace-clone",
		},
		// Trackers
		{
			slot: "tracker",
			name: "github",
			pkg: "@composio/ao-plugin-tracker-github",
		},
		{
			slot: "tracker",
			name: "linear",
			pkg: "@composio/ao-plugin-tracker-linear",
		},
		// SCM
		...
		// Notifiers
		{
			slot: "notifier",
			name: "composio",
			pkg: "@composio/ao-plugin-notifier-composio",
		},
		{
			slot: "notifier",
			name: "desktop",
			pkg: "@composio/ao-plugin-notifier-desktop",
		},
		{
			slot: "notifier",
			name: "slack",
			pkg: "@composio/ao-plugin-notifier-slack",
		},
		{
			slot: "notifier",
			name: "webhook",
			pkg: "@composio/ao-plugin-notifier-webhook",
		},
		// Terminals
		{
			slot: "terminal",
			name: "iterm2",
			pkg: "@composio/ao-plugin-terminal-iterm2",
		},
