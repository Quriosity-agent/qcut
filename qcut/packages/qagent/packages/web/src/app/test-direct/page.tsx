			...
			<div className="mx-auto max-w-7xl">
				<div className="mb-6">
					...
					<p className="mt-2 text-sm text-[var(--color-text-muted)]">
						This terminal has XDA (Extended Device Attributes) handler
						registered.
						<br />
						tmux should recognize it as XTerm and enable clipboard support (OSC
						52).
					</p>
					<div className="mt-4 rounded-lg border border-[var(--color-border-default)] bg-[var(--color-bg-secondary)] p-4">
						...
						<ol className="list-inside list-decimal space-y-1 text-sm text-[var(--color-text-muted)]">
							...
							<li>
								<strong>Expected:</strong> Clipboard works without iTerm2
								attachment!
							</li>
						</ol>
					</div>
					<div className="mt-4 rounded-lg border border-[var(--color-border-default)] bg-[var(--color-bg-secondary)] p-4">
						...
						<ul className="list-inside list-disc space-y-1 text-sm text-[var(--color-text-muted)]">
							...
							<li>
								OSC 52 sequences flow: tmux → WebSocket → xterm.js →
								navigator.clipboard
							</li>
						</ul>
					</div>
